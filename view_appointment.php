    ...
    <?php
        try{
            ...
            if($result->num_rows>0){
                ...
                echo "<div id='error' class='alert alert-danger' role='alert'>No existen registros con el numero de documento ingresado. Si es la primera vez que ingresa, por favor registrese en <a href='add_user.php'>este link.<a/></div>
                <div class='form-row'>
                    <a href='index.php' class='btn btn-warning btn-block'>Salir</a>
                </div>";
            }
